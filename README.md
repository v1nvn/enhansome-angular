...
* [cookieconsent](https://github.com/orestbida/cookieconsent) ⭐ 5,305 | 🐛 64 | 🌐 JavaScript | 📅 2025-05-29 - Simple cross-browser cookie-consent plugin written in vanilla js that can be added to [Angular](https://cookieconsent.orestbida.com/essential/getting-started.html#angular).
...
* [Uppy](https://github.com/transloadit/uppy) ⭐ 30,635 | 🐛 180 | 🌐 TypeScript | 📅 2026-02-16 - A sleek, modular JavaScript file uploader that [integrates seamlessly with Angular](https://uppy.io/docs/angular/).
...
* [ngx-formidable](https://github.com/Cynthion/ngx-formidable) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-15 - A powerful Angular component library for building rich, validated forms.
...
* [ngx-signal-plus](https://github.com/milad-hub/ngx-signal-plus) ⭐ 24 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-15 - A comprehensive utility library for Angular Signals that provides enhanced functionality, operators, and utilities.
...
* [dfx-common](https://github.com/Dafnik/dfx-common) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-16 - Collection of Angular libraries including `dfx-qrcode` and more.
